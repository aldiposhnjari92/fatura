...
const sq = {
  ...
  'inv.itemSaveEdit': 'Ruaj ndryshimin',
  'inv.itemCancelEdit': 'Anulo',
  'inv.itemsEmpty': 'Asnjë artikull ende. Shkruaje lart dhe shtype "Shto artikull".',
  'inv.productMemoryHint':
    'Fillo të shkruash për të parë produktet që ke faturuar më parë.',
  'inv.notes': 'Shënime',
  ...
  'inv.itemEditAria': 'Ndrysho artikullin {n}',
